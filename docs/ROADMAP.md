...
- **WP5.3 açık maddesi:** Mobil istemci, DB'de saklanan canonical meal-photo object path'ini private bucket için kısa süreli signed URL'ye çevirmelidir. Queue-owner Storage delete P2 limitation'ı korunur; bu WP5.3A kapsamında değiştirilmedi.

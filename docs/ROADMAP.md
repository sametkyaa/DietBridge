...
- **WP5.3 açık maddesi:** Mobil istemci, DB'de saklanan canonical meal-photo object path'ini private bucket için kısa süreli signed URL'ye çevirmelidir. WP5.3 kod geliştirmesi henüz başlamadı.
- **Durum:** Bekliyor.

...
const run = async () => {
  ...
  assert(migrationFiles.length === 58, 'DISPOSABLE_MIGRATION_CHAIN_58');
  ...
  assert(runSql('select count(*) from supabase_migrations.schema_migrations') === '58', 'SCHEMA_MIGRATION_REPLAY_58');

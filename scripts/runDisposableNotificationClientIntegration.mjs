...
const run = async () => {
  ...
  assert(sourceMigrations.at(-1) === '20260830060342_dietitian_diploma_storage_hardening.sql', 'CLIENT_RUNTIME_NOTIFICATION_MIGRATION_TAIL');
  ...
  try {
    ...
    assert(manifest.expectedHistory.total === 48, 'CLIENT_RUNTIME_BASELINE_48');

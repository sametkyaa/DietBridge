...
const run = async () => {
  ...
  assert(sourceMigrations.at(-1) === '20260827084741_standalone_platform_admin_access.sql', 'CLIENT_RUNTIME_NOTIFICATION_MIGRATION_TAIL');
  ...
  try {
    ...
    assert(manifest.expectedHistory.total === 47, 'CLIENT_RUNTIME_BASELINE_47');

...
const run = async () => {
  ...
  assert(sourceMigrations.at(-1) === '20260826133224_product_admin_dietitian_verification.sql', 'CLIENT_RUNTIME_NOTIFICATION_MIGRATION_TAIL');
  ...
  try {
    ...
    assert(manifest.expectedHistory.total === 46, 'CLIENT_RUNTIME_BASELINE_46');
